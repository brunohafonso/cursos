...
namespace Instituicao
{
    public class IniciarBanco
    {
        public static void Inicializar(InstituicaoContexto contexto)
        {
            ...
            var curso = new Curso(categoria.IdCategoria, "Html e Css", DateTime.Parse("25/02/2018"), DateTime.Parse("28/02/2018"), "segunda-feira,quarta-feira,sexta-feira", DateTime.Parse("20:00"), DateTime.Parse("22:00"), categoria, "Internet");
